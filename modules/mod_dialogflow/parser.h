...
using google::cloud::dialogflow::v2::VoiceSelectionParams;
using google::cloud::dialogflow::v2::SsmlVoiceGender;
using google::cloud::dialogflow::v2::SsmlVoiceGender_Name;
...
using google::cloud::dialogflow::v2::StreamingRecognitionResult_MessageType;
using google::cloud::dialogflow::v2::StreamingRecognitionResult_MessageType_Name;
using google::cloud::dialogflow::v2::EventInput;
using google::cloud::dialogflow::v2::OutputAudioEncoding;
using google::cloud::dialogflow::v2::OutputAudioEncoding_Name;
using google::cloud::dialogflow::v2::Context;
using google::cloud::dialogflow::v2::Sentiment;
using google::cloud::dialogflow::v2::SentimentAnalysisResult;
//using google::cloud::dialogflow::v2::KnowledgeAnswers;
//using google::cloud::dialogflow::v2::KnowledgeAnswers_Answer;
//using google::cloud::dialogflow::v2::KnowledgeAnswers_Answer_MatchConfidenceLevel;
//using google::cloud::dialogflow::v2::KnowledgeAnswers_Answer_MatchConfidenceLevel_Name;
using google::cloud::dialogflow::v2::Intent;
using google::cloud::dialogflow::v2::Intent_FollowupIntentInfo;
using google::cloud::dialogflow::v2::Intent_WebhookState;
using google::cloud::dialogflow::v2::Intent_WebhookState_Name;
using google::cloud::dialogflow::v2::Intent_Parameter;
using google::cloud::dialogflow::v2::Intent_TrainingPhrase;
using google::cloud::dialogflow::v2::Intent_TrainingPhrase_Type;
using google::cloud::dialogflow::v2::Intent_TrainingPhrase_Part;
using google::cloud::dialogflow::v2::Intent_TrainingPhrase_Type_Name;
using google::cloud::dialogflow::v2::Intent_Message;
using google::cloud::dialogflow::v2::Intent_Message_QuickReplies;
using google::cloud::dialogflow::v2::Intent_Message_Platform_Name;
using google::cloud::dialogflow::v2::Intent_Message_SimpleResponses;
using google::cloud::dialogflow::v2::Intent_Message_SimpleResponse;
using google::cloud::dialogflow::v2::Intent_Message_BasicCard;
using google::cloud::dialogflow::v2::Intent_Message_Card;
using google::cloud::dialogflow::v2::Intent_Message_Image;
using google::cloud::dialogflow::v2::Intent_Message_Text;
using google::cloud::dialogflow::v2::Intent_Message_Card_Button;
using google::cloud::dialogflow::v2::Intent_Message_BasicCard_Button;
using google::cloud::dialogflow::v2::Intent_Message_BasicCard_Button_OpenUriAction;
using google::cloud::dialogflow::v2::Intent_Message_Suggestion;
using google::cloud::dialogflow::v2::Intent_Message_Suggestions;
using google::cloud::dialogflow::v2::Intent_Message_LinkOutSuggestion;
using google::cloud::dialogflow::v2::Intent_Message_ListSelect;
using google::cloud::dialogflow::v2::Intent_Message_CarouselSelect;
using google::cloud::dialogflow::v2::Intent_Message_CarouselSelect_Item;
using google::cloud::dialogflow::v2::Intent_Message_ListSelect_Item;
using google::cloud::dialogflow::v2::Intent_Message_SelectItemInfo;
//using google::cloud::dialogflow::v2::Intent_Message_TelephonyPlayAudio;
//using google::cloud::dialogflow::v2::Intent_Message_TelephonySynthesizeSpeech;
//using google::cloud::dialogflow::v2::Intent_Message_TelephonyTransferCall;
...
public:
    ...
    cJSON* parse(const google::cloud::dialogflow::v2::Context& o) ;
